  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-2">Welcome back! Here's an overview of your activities.</p>
      </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="p-4 bg-blue-50 dark:bg-blue-900 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-800 transition-colors">
              ...
              <p className="text-sm font-medium text-blue-600 dark:text-blue-400">Add User</p>
            </button>
            <button className="p-4 bg-green-50 dark:bg-green-900 rounded-lg hover:bg-green-100 dark:hover:bg-green-800 transition-colors">
              <svg className="w-6 h-6 text-green-600 dark:text-green-400 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
              </svg>
              <p className="text-sm font-medium text-green-600 dark:text-green-400">View Reports</p>
            </button>
            <button className="p-4 bg-yellow-50 dark:bg-yellow-900 rounded-lg hover:bg-yellow-100 dark:hover:bg-yellow-800 transition-colors">
              <svg className="w-6 h-6 text-yellow-600 dark:text-yellow-400 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-sm font-medium text-yellow-600 dark:text-yellow-400">Settings</p>
            </button>
            <button className="p-4 bg-purple-50 dark:bg-purple-900 rounded-lg hover:bg-purple-100 dark:hover:bg-purple-800 transition-colors">
              ...
              <p className="text-sm font-medium text-purple-600 dark:text-purple-400">Support</p>
            </button>
          </div>
        </div>
      </div>
